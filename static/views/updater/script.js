const { update, version: currentVersion } = await MooncordUpdaterNative.getData();
...
document.getElementById("update-button").addEventListener("click", () => {
    ...
    MooncordUpdaterNative.installUpdate().then(() => {
...
document.getElementById("later-button").addEventListener("click", () => MooncordUpdaterNative.snoozeUpdate());
document.getElementById("ignore-button").addEventListener("click", () => {
    ...
    if (confirmed) MooncordUpdaterNative.ignoreUpdate();
});

MooncordUpdaterNative.onProgress(percent => (downloadProgress.value = percent));
MooncordUpdaterNative.onError(message => {
    updateDialog.closedBy = "any";
