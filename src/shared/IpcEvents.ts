...
export const enum IpcEvents {
    ...
    GET_MOONCORD_RENDERER_SCRIPT = "VCD_GET_RENDERER_SCRIPT",
    GET_MOONCORD_RENDERER_CSS = "VCD_GET_RENDERER_CSS",
    MOONCORD_RENDERER_CSS_UPDATE = "VCD_PRELOAD_RENDERER_CSS_UPDATE",
    ...
    IMPORT_VENCORD_SETTINGS = "VCD_IMPORT_VENCORD_SETTINGS",

    GET_MOONCORD_TABS = "MOONCORD_GET_TABS",
    MOONCORD_TABS_UPDATED = "MOONCORD_TABS_UPDATED",
    SELECT_MOONCORD_TAB = "MOONCORD_SELECT_TAB",
    CREATE_MOONCORD_TAB = "MOONCORD_CREATE_TAB",
    CLOSE_MOONCORD_TAB = "MOONCORD_CLOSE_TAB",
    RENAME_MOONCORD_TAB = "MOONCORD_RENAME_TAB",
    REORDER_MOONCORD_TAB = "MOONCORD_REORDER_TAB",
    RESET_MOONCORD_TABS = "MOONCORD_RESET_TABS",
    OPEN_DISCORD_SETTINGS = "MOONCORD_OPEN_DISCORD_SETTINGS",
    DISCORD_BACK = "MOONCORD_DISCORD_BACK",
    DISCORD_FORWARD = "MOONCORD_DISCORD_FORWARD",
    DISCORD_RELOAD = "MOONCORD_DISCORD_RELOAD",
    RELOAD_MOONCORD_TAB = "MOONCORD_RELOAD_TAB",
    OPEN_MOONCORD_TAB_DEVTOOLS = "MOONCORD_OPEN_TAB_DEVTOOLS",
    WAIT_FOR_MOONCORD_TAB = "MOONCORD_WAIT_FOR_TAB",
    MOONCORD_TAB_ACTIVITY = "MOONCORD_TAB_ACTIVITY",
    ...
    TOGGLE_DEVTOOLS = "VCD_TOGGLE_DEVTOOLS",
