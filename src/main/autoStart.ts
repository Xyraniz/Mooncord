...
function makeAutoStartLinuxDesktop(): AutoStart {
    ...
    const file = join(dir, "mooncord.desktop");
    ...
    return {
        ...
        enable() {
            const desktopFile = stripIndent`
                ...
                Type=Application
                Name=Mooncord
                Comment=Mooncord autostart script
...
// The portal call uses the app id by default, which is org.chromium.Chromium, even in packaged Mooncord.
// This leads to an autostart entry named "Chromium" instead of "Mooncord".
